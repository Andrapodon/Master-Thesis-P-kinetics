...
different sets of soil properties. Both amorphous aluminum (\(Al_{d}\))
and iron (\(Fe_{d}\)) oxides had a highly significant negative effect on
the \textbf{Desorbable P pool (}\(P_{desorb}\)), suggesting they bind P
strongly. In contrast, \textbf{Organic Carbon (}\(C_{org}\)) had a
