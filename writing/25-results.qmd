...
Tables_yield_lm <- benchmark_results$table_yield_lm
Tables_yield_weather_lm <- benchmark_results$table_yield_weather_lm
Tables_earth_lm <- benchmark_results$table_earth_lm
```
