...
variables_df <- data.frame(
  Abbreviation = c("$Y_{rel}$", "$P_{up}$", "$P_{bal}$", "$k$", "$P_{desorb}$", "$J_0$", "$P_w$", "$P_{AAE10}$"),
  `Full Name` = c("Relative Yield", "P Uptake", "P Balance", "Rate Constant", "Desorbable P", "Initial P Flux", "Water-Soluble P", "Chelate-Extractable P"),
