...
The net-desorption was observed, a kinetic of first order was assumed: 
$$\frac{dP}{dt}=k\times(P^S-P)$$ 
When solved with $P(0)=0$, the following equation was obtained: 
$$P(t)=P^S\times(1-e^{-kt})$$ 
The researchers estimated $P^S=P_\text{CAL/Olsen}-P_{H_2O}$ and linearized as follows: 
$$log(1-\frac{P(t)}{P^S})=-kt$$ $PS$, $k$ and $k*PS$ were extracted, $k*PS$ being the average net-release speed.
