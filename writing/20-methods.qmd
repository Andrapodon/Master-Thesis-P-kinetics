...
### Original Method of Flossmann and Richter (1982) {#sec-original-method-of-flossmann-and-richter-(1982}
...
variables_df <- data.frame(
  Abbreviation = c("$Y_{rel}$","$Y_{norm}$", "$P_{up}$", "$P_{bal}$", "$k$", "$P_{desorb}$", "$J_0$", "$P_{CO2}$", "$P_{AAE10}$"),
  `Full Name` = c("Relative Yield","Normalized Yield", "P Uptake", "P Balance", "Rate Constant", "Desorbable P", "Initial P Flux", "Water-Soluble P", "Chelate-Extractable P"),
  Role = c("Response","Response", "Response", "Response", "Predictor", "Predictor", "Predictor", "Predictor", "Predictor"),
  Description = c(
