...
#| fig-cap: "Diagnostic plot for $P_{\\text{AAE10}}$ (left axis) and $P_{\\text{CO_2}}$ (right axis) for all replicates at the Ellighausen (ELL) site, faceted by P fertilization treatment."
#| echo: false
#| warning: false
#| message: false
#| out-width: "\\textwidth"
