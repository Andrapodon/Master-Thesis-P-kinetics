...
create_coef_table <- function(lmer_models, 
  ...
  results_df <- data.frame(descriptor = rownames(results_matrix),
                           results_matrix,
...
# |$Al_{ox}$  |-8.706***    |-0.072*** |-8.631*** |-4.417***  |-9.473***   |
# |$Fe_{ox}$  |-1.068***    |0.005     |-1.084*** |-0.845***  |-0.606***   |
